# Generated by Django 5.1.2 on 2024-11-25 03:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('display', models.BooleanField(default=True, help_text='If selected, this product will be displayed in Site Gallery', verbose_name='Gallery Display Enabled')),
                ('shopify_sync', models.BooleanField(default=False, help_text="If selected, this product's data will synced with Shopify and available via the Shopify Online Store and Shopify POS. Please note, updates made via Shopify Admin will be overridden, and do not sync with this site.", verbose_name='Shopify Sync Enabled')),
                ('shopify_global_id', models.CharField(blank=True, editable=False, help_text='Shopify Global productID', max_length=100)),
                ('shopify_status', models.CharField(choices=[('ACTIVE', 'Active'), ('DRAFT', 'Draft'), ('ARCHIVED', 'Archived')], default='DRAFT', max_length=10)),
